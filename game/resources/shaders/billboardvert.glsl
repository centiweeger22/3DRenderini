...
void main() {
  ...
  vec4 centerPoint = vec4(0,0,0,2);
  gl_Position = u_projectionMatrix * u_viewMatrix * u_objectMatrix * centerPoint;//poectionMatrix// * viewMatrix * modelMatrix * vertexPosition;
